...
const gameGUID = "3030-9286"; //ecco1
export default class ecco1GamePage extends Component {
    constructor(props) {
        super(props);
        this.state = {
            game: {},
    ...
    gameData = (e) => {
        ...
        //Images
        const image1 = <img class="gridImage" src="https://static.giantbomb.com/uploads/original/0/6384/456231-ecco_gen_screenshot1.jpg.gif" alt="imageForGrid" height="100" Width="100" />;
        const image2 = <img class="gridImage" src="https://static.giantbomb.com/uploads/original/0/6384/456246-revieweccothedolphin_6.jpg" alt="imageForGrid" height="100" Width="100" />;
        const image3 = <img class="gridImage" src="https://static.giantbomb.com/uploads/original/0/6384/456233-ecco_gen_screenshot3.jpg.gif" alt="imageForGrid" height="100" Width="100" />;
        const image4 = <img class="gridImage" src="https://static.giantbomb.com/uploads/original/0/6384/456234-ecco_gen_screenshot4.jpg.gif" alt="imageForGrid" height="100" Width="100" />;
        const image5 = <img class="gridImage" src="https://static.giantbomb.com/uploads/original/2/23093/2763964-eccothedolphin001.png" alt="imageForGrid" height="100" Width="100" />;
        const image6 = <img class="gridImage" src="https://static.giantbomb.com/uploads/original/0/8480/246398-ecco201.jpg" alt="imageForGrid" height="100" Width="100" />;
        const image7 = <img class="gridImage" src="https://static.giantbomb.com/uploads/original/0/8480/246400-ecco1.png" alt="imageForGrid" height="100" Width="100" />;
        const modalImage1 = <img class="modalImage" src="https://static.giantbomb.com/uploads/original/0/6384/456231-ecco_gen_screenshot1.jpg.gif" alt="imageForModal"/>;
        const modalImage2 = <img class="modalImage" src="https://static.giantbomb.com/uploads/original/0/6384/456246-revieweccothedolphin_6.jpg" alt="imageForModal"/>;
        const modalImage3 = <img class="modalImage" src="https://static.giantbomb.com/uploads/original/0/6384/456233-ecco_gen_screenshot3.jpg.gif" alt="imageForModal"/>;
        const modalImage4 = <img class="modalImage" src="https://static.giantbomb.com/uploads/original/0/6384/456234-ecco_gen_screenshot4.jpg.gif" alt="imageForModal"/>;
        const modalImage5 = <img class="modalImage" src="https://static.giantbomb.com/uploads/original/2/23093/2763964-eccothedolphin001.png" alt="imageForModal"/>;
        const modalImage6 = <img class="modalImage" src="https://static.giantbomb.com/uploads/original/0/8480/246398-ecco201.jpg" alt="imageForModal"/>;
        const modalImage7 = <img class="modalImage" src="https://static.giantbomb.com/uploads/original/0/8480/246400-ecco1.png" alt="imageForModal"/>;
        ...
        .then(res => {
            ...
            this.setState({
                game: {
                    ...
                    giantBombLink: "https://www.giantbomb.com/ecco-the-dolphin/" + gameGUID + "/"
