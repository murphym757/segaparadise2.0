...
const gameGUID = "3030-15489"; //pocahontas
export default class pocahontasGamePage extends Component {
    constructor(props) {
        super(props);
        this.state = {
            game: {},
    ...
    gameData = (e) => {
        const gameDescription = "Pochahontas is a videogame based on the Disney Animated Movie of the same name. In it you control both the Native American princess herself, as well as her trusty animal sidekick Meiko. The goal of the game is to rescue animals that give you new powers and abilities.";
        ...
        //Images
        const image1 = <img class="gridImage" src="https://static.giantbomb.com/uploads/original/2/29615/1542184-poca01.png" alt="imageForGrid" height="100" Width="100" />;
        const image2 = <img class="gridImage" src="https://static.giantbomb.com/uploads/original/2/29615/1542187-poca04.png" alt="imageForGrid" height="100" Width="100" />;
        const image3 = <img class="gridImage" src="https://static.giantbomb.com/uploads/original/2/29615/1542190-poca07.png" alt="imageForGrid" height="100" Width="100" />;
        const image4 = <img class="gridImage" src="https://static.giantbomb.com/uploads/original/2/29615/1542194-poca11.png" alt="imageForGrid" height="100" Width="100" />;
        const image5 = <img class="gridImage" src="https://static.giantbomb.com/uploads/original/2/29615/1542196-poca13.png" alt="imageForGrid" height="100" Width="100" />;
        const image6 = <img class="gridImage" src="https://static.giantbomb.com/uploads/original/2/29615/1542198-poca15.png" alt="imageForGrid" height="100" Width="100" />;
        const image7 = <img class="gridImage" src="https://static.giantbomb.com/uploads/original/2/29615/1542193-poca10.png" alt="imageForGrid" height="100" Width="100" />;
        const modalImage1 = <img class="modalImage" src="https://static.giantbomb.com/uploads/original/2/29615/1542184-poca01.png" alt="imageForModal"/>;
        const modalImage2 = <img class="modalImage" src="https://static.giantbomb.com/uploads/original/2/29615/1542187-poca04.png" alt="imageForModal"/>;
        const modalImage3 = <img class="modalImage" src="https://static.giantbomb.com/uploads/original/2/29615/1542190-poca07.png" alt="imageForModal"/>;
        const modalImage4 = <img class="modalImage" src="https://static.giantbomb.com/uploads/original/2/29615/1542194-poca11.png" alt="imageForModal"/>;
        const modalImage5 = <img class="modalImage" src="https://static.giantbomb.com/uploads/original/2/29615/1542196-poca13.png" alt="imageForModal"/>;
        const modalImage6 = <img class="modalImage" src="https://static.giantbomb.com/uploads/original/2/29615/1542198-poca15.png" alt="imageForModal"/>;
        const modalImage7 = <img class="modalImage" src="https://static.giantbomb.com/uploads/original/2/29615/1542193-poca10.png" alt="imageForModal"/>;
        ...
        .then(res => {
            ...
            this.setState({
                game: {
                    ...
                    giantBombLink: "https://www.giantbomb.com/disneys-pocahontas/" + gameGUID + "/"
